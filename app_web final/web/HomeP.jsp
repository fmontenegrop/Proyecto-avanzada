                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            <a type="submit" name="docente" value="nombre" class="btn btn-outline-info" href="Controlador?accion=perfil&docente=${docente.getNombre()}" target="myFrame">${docente.getNombre()}</a>
                        </div>
                    </div>
